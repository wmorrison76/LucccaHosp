...
import { Plus, Upload, FileText, Download, Eye, Edit, Trash2, Clock, CheckCircle, AlertTriangle, Users, Calendar, DollarSign, ChefHat, Utensils, Settings, Send, Copy, Printer, FileIcon, Zap, Target, TrendingUp, PieChart, BarChart3, Search, Filter, SortAsc, MoreVertical, MessageSquare, Bell, RefreshCw, ExternalLink, Paperclip, MapPin, Phone, Mail, Home, Shield } from 'lucide-react';
import { 
  Project, 
  BEO, 
  Quote, 
