...
import { Bot, Sparkles, TrendingUp, Users, Calendar, DollarSign, Heart, Star, Gift, Camera, Music, Utensils, Lightbulb, Target, CheckCircle, Plus, MessageSquare, Zap, Shield, BrainCircuit, Send, ThumbsUp, ThumbsDown, RefreshCw, AlertTriangle, Clock, Phone, Mail, FileText, Headphones, Award, TrendingDown, HelpCircle } from 'lucide-react';
