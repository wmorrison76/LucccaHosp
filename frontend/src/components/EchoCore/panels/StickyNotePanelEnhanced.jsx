    ...
    >
      ...
      {showReminderForm && (
        <div style={{
          ...
          <div style={{ fontSize: "11px", color: "#666", padding: "6px", backgroundColor: "rgba(59, 130, 246, 0.1)", borderRadius: "4px" }}>
            📌 User/Group: [Framework - Connect permissions later]
          </div>
