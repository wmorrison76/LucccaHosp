#!/usr/bin/env node
// Code Map (robust traverse import) — works across @babel/traverse export shapes
...
const babelTraverse =
  (babelTraverseNS && typeof babelTraverseNS.default === 'function')
    ? babelTraverseNS.default
    : (typeof babelTraverseNS === 'function' ? babelTraverseNS : null);
