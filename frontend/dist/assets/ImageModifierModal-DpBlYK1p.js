import { g as getDefaultExportFromCjs, r as reactExports, j as jsxDevRuntimeExports } from "./index-DfBvRGLH.js";
...
const ImageModifierModal = ({ imageSrc, onClose, onConfirm }) => {
  ...
  const onCropComplete = reactExports.useCallback((_, croppedPixels) => {
  ...
  return /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "fixed inset-0 bg-black/70 z-50 flex items-center justify-center", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "bg-white p-4 rounded-lg shadow-md w-[90%] max-w-xl", children: [
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "relative w-full h-[300px] bg-gray-200", children: /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV(
      Cropper,
      {
        image: imageSrc,
        crop,
      ...
      false,
      {
        fileName: "/app/code/frontend/src/components/ImageModifierModal.jsx",
        lineNumber: 28,
        columnNumber: 11
      },
      void 0
    ...
    /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("div", { className: "flex justify-between mt-4", children: [
      /* @__PURE__ */ jsxDevRuntimeExports.jsxDEV("button", { onClick: onClose, className: "text-red-600 font-medium", children: "Cancel" }, void 0, false, {
        fileName: "/app/code/frontend/src/components/ImageModifierModal.jsx",
        lineNumber: 39,
        columnNumber: 11
      }, void 0),
